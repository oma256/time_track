...
$.datepicker._get_original = $.datepicker._get, $.datepicker._get = function (t, e) {
            ...
            switch (n || (n = new _datepickerExtension, $(this.dpDiv).data("datepickerExtensionRange", n)), n.range = a, n.range_multiple_max = t.settings.range_multiple_max || 0, e) {
                case"onSelect":
                    ...
                    r || (r = function () {
                        ...
                        n.onSelect(t, e), r(t, e, n), s._datepickerShowing = !1, setTimeout(function () {
                            s._updateDatepicker(e), s._datepickerShowing = !0, $("td.selected > *", e.dpDiv).addClass("ui-state-active"), "multiple" == a && $("td:not(.selected) > *", e.dpDiv).removeClass("ui-state-active")
                        })
                    };
                    break;
                case"beforeShowDay":
                ...
                case"onChangeMonthYear":
                    ...
                    r || (r = function () {
                        ...
                        r(t, e, i), setTimeout(function () {
                            $("td.selected > *", i.dpDiv).addClass("ui-state-active")
                        })
                    }
            }
    }
    ...
    switch (a) {
        case"period":
            ("object" != typeof e || void 0 == e.length) && (e = [e, e]), s.step = 0, $.datepicker._setDate_original(t, e[0], i), s.startDate = this._getDate(t), s.startDateText = this._formatDate(t), $.datepicker._setDate_original(t, e[1], i), s.endDate = this._getDate(t), s.endDateText = this._formatDate(t);
            break;
        case"multiple":
